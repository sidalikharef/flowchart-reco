...
import "./index.css";
import "./output.css";
import StartNodes from "./Node/StartNode";
import EndNodes from "./Node/EndNode";
import CollectorNode from "./Node/CollectorNode";
    ...
    const handleSVGMouseUp = useCallback(
      (event: React.MouseEvent<SVGSVGElement>) => {
        ...
        if (creatingInfo) {
          ...
          if (creatingInfo.type === "collector") {
            const point = {
              x:
                roundTo10(nativeEvent.offsetX - defaultNodeSize.width / 2) /
                zoom,
              y:
          ...
          <div className="body">
            <div className="App">
                    ...
                    >
                      ...
                      {selectionAreaCorners && (
                        <rect
                          ...
                          width={
                            selectionAreaCorners.end.x -
                            selectionAreaCorners.start.x
                          }
                          height={
                            selectionAreaCorners.end.y -
                            selectionAreaCorners.start.y
                          }
                        />
                      )}
                    ...
                    >
                      <svg style={zoomStyle}>
                        {creatingInfo.type === "start" ? (
                          <StartNodes data={StartNode} />
                        ) : creatingInfo.type === "end" ? (
                          <EndNodes data={EndNode} />
                        ) : creatingInfo.type === "operation" ? (
                          <OperationNode data={templateNode} />
                        ) : (
                          <CollectorNode data={Collector} />
                        )}
              ...
              <div className="bottomBody">
                <Button variant="Status" onClick={statusChanger}>
                  Status
                </Button>
              </div>
            </div>
